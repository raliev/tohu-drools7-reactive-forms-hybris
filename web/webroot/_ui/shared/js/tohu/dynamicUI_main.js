...
*/
	...
	/*if ($(location).attr("port") != null ) {
		baseURL = baseURL + ":" + $(location).attr("port");
	}
*/
	var context = $(location).attr('pathname').split("/")[1];
...
/*	if (getDroolsURL() == null) {
		...
		if ($(location).param("knowledgebase") != null) {
			setDroolsURL(baseURL + "/tohu?agent=" + $(location).param("knowledgebase"));
		}
...
/*
	if (isGUIBusyID == null) {
		...
		isGUIBusyID = $(location).param("isGUIBusyID");
	}
*/
}
